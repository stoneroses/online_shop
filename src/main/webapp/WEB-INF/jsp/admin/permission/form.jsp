    ...
    <form:form method="POST" modelAttribute="permission" action="${ctx}/admin/permissions/save" class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          <label for="name" class="col-sm-2 control-label"><spring:message code="permission.name" /></label>
          <div class="col-sm-10">
        ...
        <div class="form-group">
          <label for="description" class="col-sm-2 control-label"><spring:message code="permission.description" /></label>
          <div class="col-sm-10">
